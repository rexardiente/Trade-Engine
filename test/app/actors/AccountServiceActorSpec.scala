...
class AccountServiceActorSpec extends PlaySpec
  ...
  // "AccountServiceActor" should {
  //   "get pair list" in {
  //     val request = PairlistRequest(Transaction.pairlist, UUID.randomUUID)
  //     val res = controller.getAccountSvr ! request
  //     println(res)
  //   }
  // }
}
